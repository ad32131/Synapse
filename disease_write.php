...
<div class="body">
<form id="frm1" name="frm1" method="post" action="./disease_write_action.php">
    <p class="page_title"><?php echo $config_s->disease_infomation_write ?></p>
    <?php echo $config_s->title ?>:<input type="text" name="title" size="95%" minlength="1" maxlangth="100" placeholder="<?php echo $config_s->enter_title ?>" autofocus></br>
	<?php echo $config_s->Medicalmenu1 ?>:<input type="text" name="MedicalSubject1" size="95%" minlength="1" maxlangth="100" placeholder="<?php echo $config_s->Medicalmenu1 ?>" ></br>
	<?php echo $config_s->Medicalmenu2 ?>:<input type="text" name="MedicalSubject2" size="95%" minlength="1" maxlangth="100" placeholder="<?php echo $config_s->Medicalmenu2 ?>" ></br>
	<?php echo $config_s->Medicalmenu3 ?>:<input type="text" name="MedicalSubject3" size="95%" minlength="1" maxlangth="100" placeholder="<?php echo $config_s->Medicalmenu3 ?>" ></br>
    <br>
