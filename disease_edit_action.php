...
$Idx = $_POST['Idx'];
$DiseaseTitle = $_POST['DiseaseTitle'];
$DiseaseContents = $_POST['DiseaseContents'];
...
$DiseaseTitle = preg_replace("/[\'\"]/i", "", $DiseaseTitle);
$DiseaseContents = preg_replace("/[\'\"]/i", "", $DiseaseContents);
...
$sql = "UPDATE DiseaseInfo SET DiseaseTitle='$DiseaseTitle',DiseaseContents='$DiseaseContents',MedicalSubject1='$MedicalSubject1',MedicalSubject2='$MedicalSubject2',MedicalSubject3='$MedicalSubject3' WHERE Idx='$Idx';";
