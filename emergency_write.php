...
<div class="body">
<form id="frm1" name="frm1" method="post" action="./emergency_write_action.php">
    <p class="page_title"><?php echo $config_s->emergency_infomation_write ?></p>
    <input type="text" name="title" size="95%" minlength="1" maxlangth="100" placeholder="<?php echo $config_s->emergency_write_text_1 ?>" autofocus>
    <br>
	<input type="text" name="content" size="95%" minlength="1" maxlangth="100" placeholder="<?php echo $config_s->emergency_write_text_2 ?>">
	</form>
    <div align="right">
